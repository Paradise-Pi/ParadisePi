...
export class SimplifyConfig1652626978152 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`INSERT INTO "temporary_config"("key", "value") SELECT "key", "value" FROM "config"`)
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "sndConfig" RENAME TO "temporary_sndConfig"`)
		await queryRunner.query(`CREATE TABLE "sndConfig" ("key" text PRIMARY KEY NOT NULL, "value" text NOT NULL)`)
		await queryRunner.query(
			`INSERT INTO "sndConfig"("key", "value") SELECT "key", "value" FROM "temporary_sndConfig"`
		)
		await queryRunner.query(`DROP TABLE "temporary_sndConfig"`)
		await queryRunner.query(`ALTER TABLE "lxConfig" RENAME TO "temporary_lxConfig"`)
		await queryRunner.query(`CREATE TABLE "lxConfig" ("key" text PRIMARY KEY NOT NULL, "value" text NOT NULL)`)
		await queryRunner.query(
			`INSERT INTO "lxConfig"("key", "value") SELECT "key", "value" FROM "temporary_lxConfig"`
		)
		await queryRunner.query(`DROP TABLE "temporary_lxConfig"`)
		await queryRunner.query(`ALTER TABLE "config" RENAME TO "temporary_config"`)
		await queryRunner.query(`CREATE TABLE "config" ("key" text PRIMARY KEY NOT NULL, "value" text NOT NULL)`)
		await queryRunner.query(`INSERT INTO "config"("key", "value") SELECT "key", "value" FROM "temporary_config"`)
		await queryRunner.query(`DROP TABLE "temporary_config"`)
		await queryRunner.query(`ALTER TABLE "sndConfig" RENAME TO "temporary_sndConfig"`)
		await queryRunner.query(
