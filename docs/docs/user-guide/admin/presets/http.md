...
HTTP presets can be linked to a device, which allows you to store the IP address/host of the device in one place.
![HTTP editing](@site/static/img/tutorial/admin/admin-preset-http.png)
Alternatively, you can enter the URL directly.
![HTTP editing](@site/static/img/tutorial/admin/admin-preset-http-no-device.png)
